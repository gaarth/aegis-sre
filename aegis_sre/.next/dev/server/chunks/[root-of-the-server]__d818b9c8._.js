...
"[project]/Documents/cityboy/aegis_sre/app/api/incidents/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
// Server-side API route for fetching incidents ΓÇö uses service_role to bypass RLS
...
async function GET() {
    ...
    const { data, error } = await supabase.from('incidents').select('*').order('created_at', {
        ascending: false
    }).limit(50);
    if (error) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$cityboy$2f$aegis_sre$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(data);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__d818b9c8._.js.map